      ...
      <div className="bg-white shadow-md rounded-xl p-6 w-full max-w-md">
        ...
        <div className="flex flex-col items-center space-y-4">
          <input
            ...
            className="block w-full text-sm text-black file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-blue-500 file:text-white hover:file:bg-blue-600 cursor-pointer"
          />
