  ...
  return (
    <div className="flex flex-col items-center text-black justify-center min-h-screen bg-gray-100">
      ...
      <form
        ...
        className="bg-white p-6 rounded text-black shadow-md w-full max-w-md"
      >
        <div className="mb-4">
        ...
        <div className="mb-4">
          <label htmlFor="new-password" className="block text-black">
            New Password:
          </label>
          <input
            type="password"
        ...
        <div className="mb-4">
          <label htmlFor="confirm-password" className="block text-black">
            Confirm Password:
          </label>
          <input
            type="password"
